...
$login = login($nomor);
echo @color('white', $login['message']."\n");
...
if (strpos(json_encode($login), '"status":true')) {
	...
	echo @color('white', "PULSA\t\t: ");
	echo @color('white', "$balance\n");
	echo @color('white', "MASA AKTIF\t: ");
	echo @color('white', "$aktif\n");
    echo @color('white', "SISA KUOTA\t: ");
    echo @color('white', "$sisakuota\n");
    echo @color('white', "BONSTRI\t\t: ");
    echo @color('white', "$poin Poin\n");
    cek:
    echo @color('white', "PILIH PAKET:\n");
    ...
    switch ($pilih) {
        ...
        default:
            echo @color('white', "PILIH PAKET TERLEBIH DAHULU\n");
            goto cek;
            break;
    }
    $cek = cek($prodid);
    ...
    echo @color('white', "NAMA PAKET\t: ");
    echo @color('white', "$name\n");
    echo @color('white', "HARGA\t\t: ");
    echo @color('white', "$price\n");
    echo @color('white', "DESKRIPSI\t: ");
    echo @color('white', "$deskripsi\n");
    echo @color('white', "LANJUT ? (y/n) :");
    $aa = trim(fgets(STDIN));
    if(strtolower($aa) !== 'y') {
        goto cek;
    }
